...
initiative  = ds_grid_get(heroStats, statsIndex, HEROSTATS.initiative); // who moves first
fortitude   = ds_grid_get(heroStats, statsIndex, HEROSTATS.fortitude);  // mental strength against panic, fear, etc
