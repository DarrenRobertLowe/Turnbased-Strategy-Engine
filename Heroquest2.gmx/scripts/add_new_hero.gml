/// add_new_hero(type, sex, "name", hp, mp, move, attack, defence, main weapon, off-hand, amulet, ring1, ring2, armour, hair, face, skin);
...
var this_attack  = argument[6];
var this_defence = argument[7];
var this_weapon  = argument[8];
var this_offhand = argument[9];
var this_amulet  = argument[10];
var this_ring1   = argument[11];
var this_ring2   = argument[12];
var this_armour  = argument[13];
var this_hair    = argument[14];
var this_face    = argument[15];
var this_skin    = argument[16];
